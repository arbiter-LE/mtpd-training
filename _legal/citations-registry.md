...
| Drivers of emergency vehicles | **75** Pa.C.S. § 3105 | Vehicle Code: emergency-vehicle drivers responding to a call or in pursuit may park/stand, proceed past red signals/stop signs after slowing, exceed speed limits (without endangering life or property), and disregard direction-of-movement rules — privileges apply **only with audible and visual signals** (subsec. (c)); subsec. (e): the section **"does not relieve the driver... from the duty to drive with due regard for the safety of all persons."** **Title 75, not Title 18.** | GOOD LAW | 2026-07-06 | legis.state.pa.us (Title 75 ch. 31, full text read) | index.html |
| PFA — responsibilities of law enforcement | **23** Pa.C.S. § 6105 | PFA Act: agencies must train all officers on the chapter and adopt a written DV policy (a); give the abused person **oral and written notice of safe shelter and DV services** (incl. hotline) plus the statutory statement of PFA remedies (b); complete NIBRS-consistent incident report (c); make reasonable efforts to notify the protected party of the defendant's arrest within 24 hrs of preliminary arraignment (d); PSP maintains the Statewide PFA registry (e). | GOOD LAW | 2026-07-06 | legis.state.pa.us (Title 23 ch. 61, full text read) | EGPD-5, index.html |
| PFA — commencement of proceedings | **23** Pa.C.S. § 6106 | PFA Act: how PFA actions are **filed** — adult/emancipated minor petitions the court alleging abuse (a); no plaintiff fees (b); sheriff/LE serves petition and orders (f)–(g); **courts and hearing officers** (not police) provide the plaintiff referrals to DV programs and legal services (h). | GOOD LAW | 2026-07-06 | legis.state.pa.us (Title 23 ch. 61, full text read) | (not currently cited — was the MTPD miscite, corrected to § 6105(b) 2026-07-06) |
| PFA — relief, incl. firearms relinquishment | **23** Pa.C.S. § 6108 (+ § 6108.1) | PFA Act: court may order relief incl. (a)(7) **prohibiting firearm acquisition/possession and ordering temporary relinquishment to the sheriff/appropriate LE agency** within 24 hrs of service of the order. **Return is governed by § 6108.1:** the relinquishment order itself provides for return on expiration/dismissal, conditioned on the items not being evidence of a crime, no other federal/state prohibition, and PSP PICS/NICS clearance; if ruled ineligible, defendant petitions the court (hearing within 10 business days). | GOOD LAW | 2026-07-06 | legis.state.pa.us (§§ 6108, 6108.1, full text read) | scenarios-mtpd.js |
...
| Carroll v. United States | 267 U.S. 132 (1925) | **Federal** automobile exception: warrantless search of a vehicle is valid on **probable cause** that it carries contraband, because the vehicle "can be quickly moved out of the locality or jurisdiction in which the warrant must be sought" (267 U.S. at 153); officer must have "reasonable or probable cause for believing" the vehicle carries contraband (at 155–156). **PA caveat — never teach as the rule for PA officers:** under Art. I § 8, Commonwealth v. Alexander (2020) requires probable cause **AND** exigent circumstances; Carroll may appear only with that limitation stated. | GOOD LAW | 2026-07-06 | Official U.S. Reports PDF (LOC usrep267132, opinion pp. 151–156 read); CourtListener existence check FOUND | (not yet used in content) |
...
**2026-07-06 — final clearance:** the last in-content authorities are verified and promoted to `GOOD LAW` above: **75 Pa.C.S. § 3105** (emergency vehicles — index.html), **23 Pa.C.S. § 6105** (LE responsibilities — EGPD-5, index.html), **23 Pa.C.S. § 6106** and **§ 6108/§ 6108.1** (PFA — scenarios-mtpd.js), and **Carroll v. United States** (catalogued for future use, not yet in content). **Every authority cited anywhere in live content is now `GOOD LAW`.**

> **Title correction (2026-07-06):** this list previously catalogued "18 Pa.C.S. § 3105 · § 6105 · § 6106 · § 6108 · § 6113" as pending firearms statutes. That was a mis-filing — the codebase actually cites the **Title 75** (§ 3105, emergency vehicles) and **Title 23** (§§ 6105/6106/6108, PFA Act) sections now verified above. **No Title 18 Uniform Firearms Act section (§ 6105/6106/6108/6113) is cited anywhere in content.** If a future firearms module needs them, verify each against legis.state.pa.us before first use.

> ✅ **MTPD miscite FIXED 2026-07-06 (Andrew approved same day):** `scenarios-mtpd.js` (DV module debrief) attributed officer victim-notification duties to **23 Pa.C.S. § 6106** (commencement of proceedings — a court duty, subsec. (h)). Corrected to **§ 6105(b)** (oral + written notice of shelter, DV services, and PFA remedies — the officer duty). Debrief text only; no quiz question or answer key touched, so no completed records affected.
...
_Last full review: 2026-06-13. PENDING queue fully cleared: 2026-07-06._
