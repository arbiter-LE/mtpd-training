...
**Prepared:** 2026-06-18 · **Updated:** 2026-06-22 · **For:** Andrew's review + business-lawyer meeting (Leah Westerman)
...
| **Pilot NDA** | `_legal-docs/agreements/2026-06-05-pilot-nda.docx` | Template | 3-yr term + 3-yr survival, PA law, equitable remedies. |
...
**2.5 — Confirm EGPD signed the DPA, not just the Service Agreement.** Officer data is being processed; the DPA should be executed, with the signed copy filed under `Agency Onboarding/EGPD/`.
